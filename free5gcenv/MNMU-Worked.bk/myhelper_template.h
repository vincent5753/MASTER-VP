...
struct interface ens18_veth = {
    .name = "ens18",
    .ifnum = 2,
    .mac = {0x86, 0x57, 0xc2, 0x95, 0xfe, 0x02},
...
struct interface cni0_veth = {
    .name = "CNI0",
    .ifnum = 5,
    .mac = {0xee, 0xec, 0xc7, 0x1d, 0xf4, 0x82},
...
UPF1Interface2replace
UPF2Interface2replace
UPF3Interface2replace
};
...
struct interface exupf_veth[EXUPF_COUNT] = {  // to cni0
    {
        .name = "EX-UPF1",
        .ifnum = 5,  // CNI0
        .mac = {0x46, 0xfe, 0x1e, 0x98, 0xbb, 0xe2},  // CNI0
        .ipv4 = 10 | (0 << 8) | (0 << 16) | (175 << 24)
    }
};

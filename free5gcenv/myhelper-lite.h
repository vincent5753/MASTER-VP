...
.name = "CNI0-EU1", .ifnum = 5, .mac = {0x2a, 0x94, 0xe5, 0x7a, 0xbc, 0x65}, .ipv4 = 10 | (244 << 8) | (0 << 16) | (5 << 24)
};

struct interface ext_upf1 = {
.name = "EX-UPF1", .ifnum = 6, .mac = {0x46, 0x40, 0x72, 0xb2, 0xf7, 0x06}, .ipv4 = 10 | (244 << 8) | (1 << 16) | (5 << 24)
};
